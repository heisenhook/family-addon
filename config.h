...
public:
	...
	config_option( bool, ragebot_debug, true );
...
#pragma region Rage general group
	...
	config_option( float, max_aim_height, 0.f );
	...
	config_option( bool, delay_shot_minimum_damage, false );
	config_option( bool, delay_shot_lby, false );
...
#pragma region ESP group
	...
	config_option( bool, crosshair_indicator_doubletap, false );
...
#pragma region MISC group
	...
	config_option( bool, show_playerlist, false );
